<template>
 ...
 <svg
      ...
      <div class="text-lg text-blue-400 flex flex-row items-center">
        ...
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="bi bi-search w-6 h-6 m-2"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <div
          class="m-1 flex flex-row items-center cursor-pointer hidden md:inline-flex"
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="bi bi-plus-circle w-6 h-6 m-2"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <div
          v-on:click="showSmallMenu = !showSmallMenu"
          class="ml-4 mr-1 text-sm text-black text-gray-700 font-extrabold cursor-pointer"
        >
          Sachin
        </div>

        <div v-on:click="showSmallMenu = !showSmallMenu">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
        ...
        <div v-on:click="showSmallMenu = !showSmallMenu">
          <svg
            ...
            height="16"
            fill="currentColor"
            class="bi bi-chevron-down cursor-pointer w-5 h-5 text-gray-700"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
 ...
 <div class="flex justify-center  md:justify-end bg-white   " v-if="showSmallMenu">
      <div class="bg-white shadow-xl absolute w-80">
        <div class="flex flex-col">
          <router-link  :to="{name:'Dashboard'}"  class="hover:bg-gray-200">
            <div class="flex flex-row px-4 py-2 justify-between items-center">
              <div class="flex flex-row items-center">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  class="bi bi-house text-gray-500"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
                ...
                <p class="text-md font-bold m-2 text-xl text-gray-500">Dashboard</p>
              </div>
    ...
    <div class="flex    flex-row justify-between mx-4 my-2 items-center">
            <div class="flex flex-row items-center">
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-signpost text-gray-500"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <div class="flex flex-row justify-between mx-4 my-2 items-center">
            <div class="flex flex-row items-center">
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-chat-left-text text-gray-500"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <div class="flex flex-row justify-between mx-4 my-2 items-center">
            <div class="flex flex-row items-center">
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-person-circle text-gray-500"
                viewBox="0 0 16 16"
              >
                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                <path
              ...
              <p class="text-md font-bold m-2 text-xl text-gray-500">Profile</p>
            </div>
          ...
          <div class="flex flex-row justify-between mx-4 my-2 items-center">
            <div class="flex flex-row items-center">
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-x-circle text-gray-500"
                viewBox="0 0 16 16"
              >
                <path
                  d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"
